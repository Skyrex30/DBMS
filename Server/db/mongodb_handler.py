...
def delete_row(database_name, table_name, primary_key):
    ...
    result = collection.update_one(
        {"_id": table_name},  # Filter by table name (which is the _id)
...
def create_index_mongo(database_name, table_name, index_fields, index_type="ascending", unique=False, sparse=False):
    ...
    Args:
        ...
        table_name (_type_): Name of the table
        index_fields (_type_): _description_
        index_type (str, optional): _description_. Defaults to "ascending".
